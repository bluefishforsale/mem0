...
def client(_mock_memory):
    ...
    # AUTH_DISABLED: these test parameter forwarding, not auth. test_server_auth.py
    # owns that, and wants the opposite mode, so neither file may rely on ambient env.
